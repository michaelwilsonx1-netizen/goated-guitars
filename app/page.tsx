...
const SHOP_FEATURES = [
    ...
    },
    {
        ...
        title: "Lessons",
        body: "Private guitar coaching for new players, returning players, and gig-ready musicians.",
        href: "/lessons",
    },
    {
        id: "repair",
        ...
        eyebrow: "Repair Shop",
        title: "Repair Bench",
        body: "Setups, electronics, fret care, and practical fixes for instruments that need attention.",
        href: "/repairs",
    },
] as const;
                            ...
                            <button
                                ...
                                onClick={() => {
                                    if ("href" in feature) {
                                        ...
                                        smoothScrollTo(feature.target);
                                    }
                                }}
                                className="shop-feature-card group min-h-[210px] ..."
