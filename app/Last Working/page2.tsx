...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <main className="global-weave-bg relative min-h-screen text-white antialiased m-0 p-0">
                <style>{`
          body, html {
          ...
          /* Responsive sizing & structural modifiers for the central rendering engine */
          .hero-canvas {
            transform: scaleX(0.85) scaleY(1.25) !important;
            transform-origin: center center !important;
          }
          @media (min-width: 1024px) {
            .hero-canvas {
              transform: scale(0.70) !important; /* Scaled down precisely by 30% */
            }
          }
        `}</style>
        ...
        ═══════════════════════════════════════ */}
                <section id="top" aria-label="Hero — Goated Guitars"
                    ...
                    <div className="flex-1 flex items-stretch relative z-10 min-h-0">
                        ...
                        <div className="w-[20vw] min-w-[220px] flex-shrink-0 relative hidden lg:block z-20 h-full" aria-hidden="true">
                            <video src="/guitar-side-1.mp4" autoPlay loop muted playsInline poster="/gt1.jpg"
                                className="absolute inset-0 h-full w-full object-cover" />
                            <div className="absolute inset-0" style={{ background: "linear-gradient(to right, transparent 40%, rgba(2,2,2,0.95) 100%)" }} />
                        </div>

                        {/* Central Canvas Container with symmetry fix */}
                        <div className="relative flex-1 min-w-0 flex items-center justify-center p-2 bg-transparent">
                            <canvas
                                ref={canvasRef}
                                aria-hidden="true"
                                className="block mx-auto text-center hero-canvas"
                                style={{
                                    width: '100%',
                                    height: 'auto',
                                    maxWidth: '100%',
                        ...
                        <div className="w-[20vw] min-w-[220px] flex-shrink-0 relative hidden lg:block z-20 h-full" aria-hidden="true">
                            <video src="/guitar-side-2.mp4" autoPlay loop muted playsInline poster="/gt4.jpg"
                                className="absolute inset-0 h-full w-full object-cover" />
                            <div className="absolute inset-0" style={{ background: "linear-gradient(to left, transparent 40%, rgba(2,2,2,0.95) 100%)" }} />
                        </div>
                    </div>

                    {/* Controls + navigation links layer element row block */}
                    <div className="relative z-20 flex justify-center items-center pb-4 pt-2 bg-transparent">
        ...
        ═══════════════════════════════════════ */}
                <section id="vault" aria-labelledby="vault-heading" className="py-24 px-4 sm:px-8 max-w-7xl mx-auto bg-transparent">
        ...
        ═══════════════════════════════════════ */}
                <section id="experience" aria-labelledby="exp-heading" className="border-y border-white/5 py-28 px-4 sm:px-8 bg-transparent">
        ...
        ═══════════════════════════════════════ */}
                <footer className="border-t border-white/5 pt-20 pb-10 px-4 sm:px-8 text-center space-y-16 bg-black/60 backdrop-blur-sm">
