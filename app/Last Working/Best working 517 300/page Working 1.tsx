...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <main className="global-weave-bg relative min-h-screen text-white antialiased m-0 p-0 overflow-x-hidden">

                {/* ─────────────────────────────────────────────────────────
                    EASY LAYOUT ADJUSTMENTS 
                    Change the values below to instantly resize videos and panels 
                ───────────────────────────────────────────────────────── */}
                <style>{`
                    body, html {
                    ...
                    .hero-canvas-responsive {
                        transform: scaleX(0.95) scaleY(1.25) !important; /* 5% thinner, 25% taller on phones */
                        transform-origin: center center !important;
                        width: 106vw !important; /* Prevents black bars on mobile edges */
                    ...
                    @media (min-width: 768px) {
                        .hero-canvas-responsive {
                            transform: none !important; /* Removes the mobile stretch entirely */
                            width: 100% !important;
                            max-width: 45vw !important; /* <-- REDUCE THIS TO MAKE CENTER VIDEO SMALLER (e.g. 35vw) */
                            height: auto !important;
                            max-height: 80vh !important; /* Prevents video from bleeding into navigation */
                            border-radius: 12px;
                        }
                        .side-panel-desktop {
                            display: block !important;
                            width: 25vw !important; /* <-- ADJUST DESKTOP SIDE PANEL WIDTH HERE */
                ...
                <section id="top" aria-label="Hero — Goated Guitars"
                    ...
                    <div className="flex-1 flex flex-row items-stretch justify-between relative z-10 min-h-0 w-full">

                        {/* Left flank track decoration stream (Strictly mapped to PC/Tablet via md: prefix) */}
                        <div className="hidden md:block side-panel-desktop relative z-20 h-full shrink-0" aria-hidden="true">
                        ...
                        <div className="relative flex-1 min-w-0 flex items-center justify-center p-2 bg-transparent z-10 overflow-hidden">
                            <canvas
                                ref={canvasRef}
                                aria-hidden="true"
        ...
        ═══════════════════════════════════════ */}
                <section id="vault" aria-labelledby="vault-heading" className="relative flex flex-row items-stretch bg-transparent w-full">

                    {/* Left Panel Vault - Desktop Only */}
                    <div aria-hidden="true" className="hidden md:block side-panel-desktop bg-black overflow-hidden relative shrink-0">
                        <div className="sticky top-[73px] h-[calc(100vh-73px)] w-full">
                            <video src="/ACO GT1.mp4" autoPlay loop muted playsInline poster="/gt1.jpg" className="h-full w-full object-cover opacity-75" />
                            <div className="absolute inset-0" style={{ background: "linear-gradient(to right, transparent 40%, rgba(2,2,2,0.95) 100%)" }} />
                        </div>
                    </div>

                    <div className="flex-1 flex flex-col gap-24 sm:gap-32 py-24 px-4 sm:px-8 bg-transparent max-w-5xl mx-auto z-10">
                    ...
                    <div aria-hidden="true" className="hidden md:block side-panel-desktop bg-black overflow-hidden relative shrink-0">
                        <div className="sticky top-[73px] h-[calc(100vh-73px)] w-full">
                            <video src="/ACO GT1.mp4" autoPlay loop muted playsInline poster="/gt4.jpg" className="h-full w-full object-cover opacity-75" />
                            <div className="absolute inset-0" style={{ background: "linear-gradient(to left, transparent 40%, rgba(2,2,2,0.95) 100%)" }} />
                        </div>
                    </div>
                </section>
